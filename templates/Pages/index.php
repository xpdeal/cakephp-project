        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link(__('View'), ['action' => 'view', $page->user_id]) ?>
                        <?= $this->Html->link(__('Edit'), ['action' => 'edit', $page->user_id]) ?>
                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $page->user_id], ['confirm' => __('Are you sure you want to delete # {0}?', $page->user_id)]) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
